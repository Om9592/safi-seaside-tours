    ...
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                {/* <p class="font-semibold uppercase tracking-wide text-blue-600 dark:text-blue-200 text-2xl">
                    Contact
                </p> */}
                <h2
            ...
            <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                    <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                        “We’d love to hear from you! Whether you’re planning your next adventure or have questions about our tours, our team is here to help.”
                    </p>
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">Halifax, Nova Scotia</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">Mobile: +1 (902) 402-7263</p>
                                <p class="text-gray-600 dark:text-slate-400">Mail: info@safiseasidetours.ca</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
